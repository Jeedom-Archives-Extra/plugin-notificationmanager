...
$plugin = plugin::byId('notificationmanager');
  ...
  <div class="col-lg-2 col-md-3 col-sm-4">
    <div class="bs-sidebar">
      <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
        <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un notifieur}}</a>
...
<?php include_file('desktop', 'notificationmanager', 'js', 'notificationmanager');?>
